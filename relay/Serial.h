...
#define Serial_RCINT_ENABLE         PIE1bits.RC1IE // EUSART1 Receive Interrupt Enable bit
#define Serial_TXINT_ENABLE         PIE1bits.TX1IE // EUSART1 Transmit Interrupt Enable bit

/* Define the EUSART bits on the IPR1 (Peripheral Interrupt Priority) Register */
#define Serial_RCINT_PRIORITY   	IPR1bits.RC1IP
#define Serial_TXINT_PRIORITY   	IPR1bits.TX1IP
